...
export default function SellerSignupScreen() {
  ...
  const handleSignup = () => {
    ...
    // Navigate to the seller verification stepper
    router.push('/(sellerTabs)/seller-verification' as any);
  };
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.formContainer}>
          ...
          <TouchableOpacity style={styles.continueButton} onPress={handleSignup}>
            <Text style={styles.continueButtonText}>Continue to Business Setup</Text>
          </TouchableOpacity>
